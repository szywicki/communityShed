...
//		toolRepo.save(new Tool("123456789012345678901234567890", "12345678901234567890123456789012345678901234567890123456789012345678901234567890", "123456789012345678901234567890", "123456789012345678901234567890", null, null, "123456789012345678901234567890", 1, null, user1));
		...
		toolRepo.save(new Tool("Wood Chisel", "Economy Wood Chisel Set(3-Piece)", "handtool", "Buck Bros.", null, null, "Available", 1, "https://s3-us-west-2.amazonaws.com/goforcode-oct2017-communityshade/Buck+Bros+Economy+Wood+Chisel+Set(3-Piece).JPG", user2));
		...
		toolRepo.save(new Tool("Jump Starter", "Dewalt 1400 Peak Amp Starter with Digital Compressor", "automotivetools", "Dewalt", null, null, "Available", 2, "https://s3-us-west-2.amazonaws.com/goforcode-oct2017-communityshade/Dewalt+1400+Peak+Amp+Starter+with+Digital+Compressor.jpg", user2));
		...
		toolRepo.save(new Tool("Torch Head", "Bernzomatic TS$000T Trigger Start Torch Head", "weldingtool", "Bernzomatic", null, null, "Available", 3, "https://s3-us-west-2.amazonaws.com/goforcode-oct2017-communityshade/Bernzomatic+TS%24000T+Trigger+Start+Torch+Head.jpg" ,user1));
